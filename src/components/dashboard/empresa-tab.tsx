...
export function EmpresaTab() {
  ...
  return (
    <section className="space-y-8">
      <div className="rounded-xl border border-border bg-foreground text-background p-6 md:p-10">
        <div className="inline-block rounded-full border border-background bg-primary text-primary-foreground text-xs font-semibold uppercase tracking-[0.12em] px-3 py-1">
          Plan Empresa
        </div>
      ...
      <div className="bg-card p-6 md:p-8 max-w-3xl">
        ...
        {sent ? (
          <div className="mt-5 rounded-xl border border-border bg-secondary text-secondary-foreground p-4 text-sm font-bold">
