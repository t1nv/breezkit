            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="text-xs rounded-xl border border-border bg-background px-3 py-1.5 hover:bg-muted transition-colors inline-flex items-center gap-1.5 font-bold"
                >
