  ...
  return (
    <>
        ...
        <section className="bk-panel bg-card p-5 md:p-7 lg:max-w-4xl">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="border-2 border-border bg-background px-4 py-2 text-sm font-bold shadow-[4px_4px_0_var(--foreground)]"
            >
      ...
      {budgetAlerts.length > 0 && (
        <section className="border-2 border-border bg-[var(--primary)] text-primary-foreground p-5 shadow-[8px_8px_0_var(--foreground)]">
      ...
      <section className="bk-panel bg-card p-5 md:p-7">
        <div className="flex items-center justify-between mb-3 gap-2 flex-wrap">
          ...
          <button
            onClick={() => onGoTab("transacciones")}
            className="border-2 border-border bg-background px-3 py-2 text-xs font-black shadow-[4px_4px_0_var(--foreground)]"
          >
            Personalizar
          </button>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {QUICK_PRESETS.map((p) => (
            <div
              key={p.category}
              className="border-2 border-border p-3 bg-background shadow-[4px_4px_0_var(--foreground)]"
            >
              <div className="text-xs font-black uppercase mb-2 flex items-center gap-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {p.amounts.map((amt) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="text-xs border-2 border-border bg-card px-2.5 py-1 font-bold disabled:opacity-50"
                  >
      ...
      <section className="bk-panel bg-card p-5 md:p-7">
        ...
        <div className="h-4 w-full bg-muted border-2 border-border overflow-hidden">
          <div
