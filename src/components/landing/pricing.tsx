...
import { ExpandOnScroll } from "./scroll-fx";
  ...
  return (
    <section id="pricing" className="py-24 md:py-32 relative">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <ExpandOnScroll className="mt-12 relative rounded-2xl border border-border bg-card p-8 md:p-10 shadow-[0_25px_60px_-20px_rgba(62,42,32,0.18)]">
          <motion.span
          ...
          <div className="text-center">
            <h3 className="font-display text-base font-semibold text-muted-foreground">Breezkit</h3>
