        ...
        <Reveal>
          ...
          >
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-4 text-muted-foreground text-lg max-w-lg">{t("cta.subtitle")}</p>
              <div className="mt-8 flex flex-wrap gap-3">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Link
                    to="/auth"
                    className="group inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-7 py-3.5 font-medium hover:bg-primary/90 transition-all shadow-lg shadow-primary/20"
                  >
                    {t("cta.cta")}
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="group inline-flex items-center gap-2 rounded-full border border-border bg-card px-7 py-3.5 font-medium hover:bg-muted transition-all"
                >
                  <GithubIcon className="h-4 w-4" /> {t("cta.github")}
                </motion.a>
              </div>
            </div>
          </motion.div>
