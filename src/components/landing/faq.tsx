          ...
          {items.map((it, i) => {
            ...
            return (
              <Reveal key={it.q} delay={i * 60}>
                <motion.div
                  layout
                  className="rounded-2xl border border-border bg-card shadow-[0_10px_30px_-10px_rgba(62,42,32,0.12)] overflow-hidden"
                >
                  <button
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      className="h-6 w-6 rounded-full border border-border grid place-items-center shrink-0"
                    >
