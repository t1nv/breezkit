...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-gradient-to-b from-transparent to-white/[0.02]">
        ...
        <div>
          ...
          <div className="mt-5 flex gap-2">
            ...
            <motion.a
              ...
              className="h-9 w-9 grid place-items-center rounded-full border border-border hover:bg-muted transition-all text-muted-foreground hover:text-foreground"
            >
